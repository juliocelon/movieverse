...
def main():
    ...
    # mass = input("Mass of a chemical sample in grams: ")
    """

    """
    Testing Procedure Step 2:
    Run your chemistry.py program and ensure that your 
    program’s output matches the following output.
    ...
    for element in periodic_table_list:
        print(f"{element[NAME_INDEX]} {element[ATOMIC_MASS_INDEX]}")
