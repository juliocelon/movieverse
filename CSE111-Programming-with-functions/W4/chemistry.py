...
"""
Author: Julio Celón
Title: W04 Project Milestone: Chemistry
...
During this milestone, you will complete part of the calculator 
by writing a function named make_periodic_table and the main function. 

The make_periodic_table function must create and return a compound 
list that contains data for all 94 naturally occuring elements.

Exceeded Requirements: 
1. Add a dictionary that contains known chemical formulas and their names.
2. Then write a function named get_formula_name
3. Call the get_formula_name function from your main function and print 
...
def compute_molar_mass(symbol_quantity_list, periodic_table_dict):
    ...
    for element in symbol_quantity_list:
        ...
        atoms_by_atomic_mass = quantity * atomic_mass
        total_molar_mass += atoms_by_atomic_mass
...
def main():
    ...
    print(f"Number of moles = {(float(mass) / float(molar_mass)):.5f} moles")
